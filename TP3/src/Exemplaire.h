...
public:
    ...
    Exemplaire(int nbPoints, std::vector<int>& types, std::vector<int>& maxSentiers, std::vector<std::vector<int> >& couts);
    ~Exemplaire();
    void setNbPoints(int nbPoints);
    void setTypes(std::vector<int>& types);
    void setMaxSentiers(std::vector<int>& maxSentiers);
    void setCouts(std::vector<std::vector<int> >& couts);
    int getNbPoints();
    std::vector<int> getTypes();
    std::vector<int> getMaxSentiers();
    std::vector<std::vector<int> > getCouts();
...
private:
    ...
    std::vector<std::vector<int> > couts; // matrice des couts entre chaque point
};
